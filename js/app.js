(() => {
    ...
    function initSliders() {
        if (document.querySelector(".consultation-block__slider")) new swiper_core_Swiper(".consultation-block__slider ", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 2,
            ...
            speed: 800,
            navigation: {
                prevEl: ".consultation-block__arrow-left",
                nextEl: ".consultation-block__arrow-right"
            },
            breakpoints: {
                375: {
                    slidesPerView: 1.25,
        ...
        if (document.querySelector(".portfolio__slider")) {
            function updateSlidePagination(swiper) {
                const totalSlides = swiper.slides.length;
                const currentIndex = swiper.realIndex + 1;
                swiper.slides.forEach(((slide, index) => {
                    const paginationElement = slide.querySelector(".my-slide-pagination");
                    if (paginationElement) paginationElement.textContent = `${currentIndex} / ${totalSlides}`;
                }));
            }
        ...
        if (document.querySelector(".feedback-specialist__slider")) new swiper_core_Swiper(".feedback-specialist__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 2,
            ...
            speed: 800,
            navigation: {
                prevEl: ".feedback-specialist__arrow-left",
                nextEl: ".feedback-specialist__arrow-right"
            },
            breakpoints: {
                374: {
                    slidesPerView: 1
        ...
        if (document.querySelector(".media__slider")) new swiper_core_Swiper(".media__slider", {
            ...
            navigation: {
                prevEl: ".media__swiper-button-prev",
                nextEl: ".media__swiper-button-next"
            },
            breakpoints: {
                375: {
                    slidesPerView: 3,
        ...
        if (document.querySelector(".photo-gallery__slider")) new swiper_core_Swiper(".photo-gallery__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            loop: true,
            ...
            navigation: {
                prevEl: ".photo-gallery__arrow-left",
                nextEl: ".photo-gallery__arrow-right"
            },
            breakpoints: {
                375: {
                    slidesPerView: 1,
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        if (searchForm) searchForm.addEventListener("submit", (function(event) {
            ...
            if (searchInput && searchInput.value) window.location.href = `/search-page.html/?q=${encodeURIComponent(searchInput.value)}`;
        }));
    }));
    window.addEventListener("load", (function() {
